...
import {
  TimelineModalMetric,
  TimelineModalRow,
  TimelineFleetTimelineItem,
  TimelineFleetModalData,
...
export class TimelineLogisticaComponent implements OnDestroy {
  frameHeight = 1400;
        ...
        this.mapMarkers = [
          {
            ...
            color: '#38bdf8',
            radius: 8,
            tooltipText: `Origem: ${this.eventModalData.mapOriginLabel || ''}`
          },
          {
            lat: destination[0],
            lng: destination[1],
            ...
            color: '#f59e0b',
            radius: 8,
            tooltipText: `Destino: ${this.eventModalData.mapDestinationLabel || ''}`
          }
        ];
        ...
        this.mapMarkers = [
          {
            ...
            color: '#22c55e',
            radius: 9,
            tooltipText: `Localizacao atual: ${this.eventModalData.mapLocationLabel || ''}`
          }
        ];
      }
    }
